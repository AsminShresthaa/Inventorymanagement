...
<?php endif; ?>
    <a href="<?php echo e(url('/auth/google/redirect')); ?>">
        <button type="button"
            class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-3">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Laravel Coffee_POS\resources\views/auth/login.blade.php ENDPATH**/ ?>