                            ...
                            <div class="card-body d-flex flex-column justify-content-between">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-1">
                                        ...
                                        <?php if($outofstock->isNotEmpty()): ?>
                                            <div class="h5 mb-0 fw-bold text-gray-400"><?php echo e(count($outofstock)); ?></div>
                                        <?php else: ?>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <?php if($outofstock->isNotEmpty()): ?>
                                        <ul class="list-group">
                                            <?php $__currentLoopData = $outofstock; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="list-group-item"><?php echo e($product->name); ?> (Stock: <?php echo e($product->stock); ?>)</li>
                                    ...
                                    <div class="card-body d-flex flex-column justify-content-between">
                                        <div class="row no-gutters align-items-center">
                                            ...
                                            <div class="text-xs fw-bold text-success mb-1">
                                                ...
                                                <div class="h5 mb-0 fw-bold text-gray-400"><?php echo e(number_format($purchaseCost, 2)); ?>
                                ...
                                <div class="col-xl-6 col-md-12 mb-3">
                                    <div class="card shadow-lg p-3 border-left-warning shadow h-100 d-flex flex-column justify-content-between" style="backdrop-filter: blur(10px); border-radius: 12px;">
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <p class="fw-bold mt-3">Cash <span class="float-end"><?php echo e($paymentMethods->where('payment_method', 'cash')->first()->count ?? 0); ?></span></p>
                                                <div class="progress">
                                                    <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo e(($paymentMethods->where('payment_method', 'cash')->first()->count ?? 0) * 10); ?>%"></div>
                                                </div>

                                                <p class="fw-bold mt-3">Mobile <span class="float-end"><?php echo e($paymentMethods->where('payment_method', 'mobile')->first()->count ?? 0); ?></span></p>
                                                <div class="progress">
                                                    <div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo e(($paymentMethods->where('payment_method', 'mobile')->first()->count ?? 0) * 10); ?>%"></div>
                                                </div>

                                                <p class="fw-bold mt-3">Card <span class="float-end"><?php echo e($paymentMethods->where('payment_method', 'card')->first()->count ?? 0); ?></span></p>
                                                <div class="progress">
                                                    <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo e(($paymentMethods->where('payment_method', 'card')->first()->count ?? 0) * 10); ?>%"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    const salesOverview = <?php echo json_encode($salesOverview, 15, 512) ?>;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (ctxPie) {
            ...
            const labels = <?php echo json_encode($labels, 15, 512) ?>; //Eat-in, deli, take_away
            const data = <?php echo json_encode($counts, 15, 512) ?>; // [25, 45]
        ...
        if (ctxTopProducts) {
            const topProductLabels = <?php echo json_encode($topProductLabels, 15, 512) ?>;
            const topProductCounts = <?php echo json_encode($topProductCounts, 15, 512) ?>;
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Laravel Coffee_POS\resources\views/admin/home.blade.php ENDPATH**/ ?>